...
<form class="layui-form" id="userinfoform" action="" style="display: none">
    <div class="layui-form-item" id="accountdiv">
        ...
        <div class="layui-input-block" id="account_inputdiv">
            <input type="text" name="acount" id="acount" required lay-verify="required" placeholder="请输入会员账号" autocomplete="off" class="layui-input">
        </div>
    </div>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="text" name="name" id="name" required  lay-verify="required" placeholder="请输入会员等级" autocomplete="off" class="layui-input">
        </div>
    </div>
    <div class="layui-form-item">
        <label class="layui-form-label">会员积分：</label>
        <div class="layui-input-block">
            <input type="text" name="pass" id="pass" required  lay-verify="required" placeholder="请输入会员积分" autocomplete="off" class="layui-input">
        </div>
    </div>
...
<script>
    layui.use('table', function(){
        ...
        table.render({
            elem: '#test'
            ,url:'/webxz/adminLevelContrller/selectAdminLevel'
            ...
            ,cols: [[
                ...
                ,{field:'acount', title:'会员账号', edit: 'text'}
                ,{field:'integral', title:'会员等级', edit: 'text'}
                ,{field:'level', title:'会员积分', edit: 'text', sort: true}
        ...
        table.on('tool(test)', function(obj){
            ...
            if(obj.event === 'del'){
                ...
                layer.confirm('真的删除行么', function(index){
                    obj.del();
                    $.ajax({
                        url:"/webxz/adminLevelContrller/deleteAdmin",
                        type: "POST",
                        data: data,
                        error: function (msg) {
                            layer.alert("服务器繁忙");
                ...
                layui.use('form', function(){
                    ...
                    form.on('submit(insertconfirm)', function(data){
                        ...
                        $.ajax({
                            url:"/webxz/adminLevelContrller/updateAdmin",
                            type: "POST",
                            data: data.field,
                            error: function (msg) {
                                layer.alert("服务器繁忙");
